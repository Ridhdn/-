...
<body>
    ...
    <div class="read_btn">
        <button class="read_btn1" onclick="location.href='./mypage.php'">목록</button>&nbsp;&nbsp;
        <button class="read_btn1" onclick="location.href='./modify.php?number=<?= $number ?>&id=<?= $_SESSION['user_id'] ?>'">수정</button>&nbsp;&nbsp;
        <button class="read_btn1" onclick="location.href='./delete.php?number=<?= $number ?>&id=<?= $_SESSION['user_id'] ?>'">삭제</button>
        <button class="read_btn1" onclick="location.href='./comment.php?number=<?= $number ?>&id=<?= $_SESSION['user_id'] ?>'">댓글</button>
    </div>
</body>
